...
% ORCID of the author: https://orcid.org/0000-0002-0066-0944
...
The demand for open science around the world is rising and many organizations are putting efforts into increasing the infrastructures available for open data \cite{panosc, nfdi, expands} \textbf{some more general references for open science are still needed here}. 
...
This is understandable, considering that large-scale facilities do produce limited, and therefore very valuable data sets, that can not easily be reproduced due to limited measurement times and should therefore be made available (after an embargo time) to the entire scientific community. 

Most large-scale offer measurement time in a proposal based system, where the best proposals are granted measurement time.
