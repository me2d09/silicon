...
The easiest way of running data analysis is to use Binder with this repository :arrow_right: [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/me2d09/silicon/main?filepath=silicon.ipynb)  
